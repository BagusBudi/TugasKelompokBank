...
public class Bank {
	...
	public static void main(String[] bank) throws Exception {
		Tabungan t;
		t= new Tabungan();
		JOptionPane.showMessageDialog(null, "SELAMAT DATANG DI BANK ","WELCOME",
		...
		System.out.println("| CREATED BY BAGUS BUDI PRAKOSO & DEDE ISKANDAR |");
		System.out.println("| 1127050024 & 1127050026 |");
		System.out.println("+===============================================+");
		System.out.println();
